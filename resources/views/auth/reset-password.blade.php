<x-layout>
    ...
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8 sm:mt-4">
        ...
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
            <h2 class="mt-10 text-center text-2xl/9 font-bold tracking-tight text-gray-700">Reset password</h2>
        </div>
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form class="space-y-6" action="/reset-password" method="POST">
                ...
                <input type="text" name="token" id="token" required value='{{ $token }}'/>

                <div>
                    <button type="submit" class="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Get </button>
                </div>
            </form>

            <p class="mt-10 text-center text-sm/6 text-gray-500">
                Remember your password?
                <a href="/login" class="font-semibold text-indigo-600 hover:text-indigo-500">Back to login</a>
            </p>
        </div>
